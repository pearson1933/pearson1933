...
/***/ "./resources/js/admin/vacancies/create.js":
/*!************************************************!*\
  !*** ./resources/js/admin/vacancies/create.js ***!
  \************************************************/
/*! no exports provided */
...
function deleteAttachment(post, attachment) {
  return new Promise(function (resolve, reject) {
    axios["delete"]("/dash/vacancies/".concat(post, "/attachment/").concat(attachment)).then(function (res) {
      resolve(res);
...
function save(formData) {
  return new Promise(function (resolve, reject) {
    axios.post("/dash/vacancies", formData).then(function (response) {
...
$(document).ready(function () {
  ...
  $("#news-post-creator form .deadline").datepicker();
  ...
  $("#news-post-save-btn").on("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var id, title, token, deadline, content, formData;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = window.post ? window.post.id : null;
            title = $("#news-post-creator form .headline").val();
            token = $("#news-post-creator form input[name='_token']").val();
            deadline = $("#news-post-creator form .deadline").val();
            ...
            save(formData).then(function (result) {
              ...
              toast.success("Vacancy post has been updated");
            })["catch"](function (error) {
              console.log(error);
  ...
  document.getElementById("attachments-upload").addEventListener("change", function (event) {
    ...
    $(this).attr("placeholder", attachment.name);
    var htm = "<li>\n                            <label class=\"form-check-label\">\n                                ".concat(attachment.name, " </label>\n                            <i class=\"remove mdi mdi-close-circle-outline delete-attachment\" style=\"color: #b66dff !important;\" data-attachment-name=\"").concat(attachment.name, "\"></i>\n                        </li>");
    $("ul#news-attachments").empty();
    $("ul#news-attachments").append(htm);
  });
  $("ul#news-attachments").on("click", "li i.delete-attachment", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
...
/***/ "./resources/js/admin/vacancies/list.js":
/*!**********************************************!*\
  !*** ./resources/js/admin/vacancies/list.js ***!
  \**********************************************/
/*! no exports provided */
...
function deletePost(id) {
  return new Promise(function (resolve, reject) {
    axios["delete"]("/dash/vacancies/".concat(id)).then(function (res) {
      console.log(res);
      resolve(res);
    })["catch"](function (error) {
...
/***/ "./resources/js/admin/vacancies/vacancies.js":
/*!***************************************************!*\
  !*** ./resources/js/admin/vacancies/vacancies.js ***!
  \***************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./create */ "./resources/js/admin/vacancies/create.js");

__webpack_require__(/*! ./list */ "./resources/js/admin/vacancies/list.js");

/***/ }),

/***/ 7:
/*!*********************************************************!*\
  !*** multi ./resources/js/admin/vacancies/vacancies.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/DC80891C8088FE70/Projects/pass2/resources/js/admin/vacancies/vacancies.js */"./resources/js/admin/vacancies/vacancies.js");
