...
/***/ "./resources/js/admin/tenders/create.js":
/*!**********************************************!*\
  !*** ./resources/js/admin/tenders/create.js ***!
  \**********************************************/
/*! no exports provided */
...
function deleteAttachment(post, attachment) {
  return new Promise(function (resolve, reject) {
    axios["delete"]("/dash/tenders/".concat(post, "/attachment/").concat(attachment)).then(function (res) {
      resolve(res);
...
function save(formData) {
  return new Promise(function (resolve, reject) {
    axios.post("/dash/tenders", formData).then(function (response) {
...
/***/ "./resources/js/admin/tenders/list.js":
/*!********************************************!*\
  !*** ./resources/js/admin/tenders/list.js ***!
  \********************************************/
/*! no exports provided */
...
function deletePost(id) {
  return new Promise(function (resolve, reject) {
    axios["delete"]("/dash/tenders/".concat(id)).then(function (res) {
      console.log(res);
      resolve(res);
    })["catch"](function (error) {
...
/***/ "./resources/js/admin/tenders/tenders.js":
/*!***********************************************!*\
  !*** ./resources/js/admin/tenders/tenders.js ***!
  \***********************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./create */ "./resources/js/admin/tenders/create.js");

__webpack_require__(/*! ./list */ "./resources/js/admin/tenders/list.js");

/***/ }),

/***/ 8:
/*!*****************************************************!*\
  !*** multi ./resources/js/admin/tenders/tenders.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/DC80891C8088FE70/Projects/pass2/resources/js/admin/tenders/tenders.js */"./resources/js/admin/tenders/tenders.js");
